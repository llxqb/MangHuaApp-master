...
public class PagingScrollHelper {
    ...
    public void setPageoffset(int pOff) {
        this.pOff = pOff;
    }
    ...
    public class MyOnFlingListener extends RecyclerView.OnFlingListener {
        ...
        public boolean onFling(int velocityX, int velocityY) {
            ...
            if (mOrientation == ORIENTATION.VERTICAL) {
                ...
                endPoint = p * (mRecyclerView.getWidth() - pOff);
            }
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (newState == 0 && mOrientation != ORIENTATION.NULL) {
                ...
                if (mOrientation == ORIENTATION.VERTICAL) {
                    ...
                    move = absY > (recyclerView.getHeight() - pOff) / 2;
                    vY = 0;
                    ...
                    move = absX > (recyclerView.getWidth() - pOff) / 2;
                    if (move) {
    ...
    private int getPageIndex() {
        ...
        if (mOrientation == ORIENTATION.VERTICAL) {
            ...
            p = offsetX / (mRecyclerView.getWidth() - pOff);
        }
        return p;
    }
    ...
    private int getStartPageIndex() {
        ...
        if (mOrientation == ORIENTATION.VERTICAL) {
            ...
            p = startX / (mRecyclerView.getWidth() - pOff);
        }
        return p;
    }
